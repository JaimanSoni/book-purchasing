            ...
            <div className=' w-[300px] sm:w-[400px] min-h-[300px] h-fit bg-white rounded-[20px] shadow-lg py-[20px] px-[30px] '>
                ...
                <form action="" className='flex flex-col justify-center items-center gap-[30px] mt-[30px]'>
                    ...
                    <div className='w-full flex items-center'>
                        <input required type={showPassword ? "text" : "password"} name="password" value={password} onChange={(e) => setPassword(e.target.value)} className='focus:outline-none focus:border-b-[2px] w-full h-[30px] px-[5px] text-[#717171] ' placeholder='Create Password' />
                    ...
                    <div className='w-full flex items-center'>
                        <input required type={showPassword ? "text" : "password"} name="password" value={password} onChange={(e) => setPassword(e.target.value)} className='focus:outline-none focus:border-b-[2px] w-full h-[30px] px-[5px] text-[#717171] ' placeholder='Confirm Password' />
